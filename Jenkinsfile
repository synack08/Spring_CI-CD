pipeline {
  ...
  environment {
    ...
    SONAR_URL   = 'http://3.238.172.45/:9000'
    NEXUS_URL   = 'http://3.238.172.45:8081/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://3.238.172.45:8081/repository/maven-snapshots/'
    }
  }
}
  }
